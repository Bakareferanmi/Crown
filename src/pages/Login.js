    ...
    <div style={styles.page}>
      ...
      <div style={styles.formPanel}>
        <div style={styles.formWrap}>
          ...
          <p style={styles.subheading}>Try admin@crown.com / admin123 or staff@crown.com / staff123</p>
...
const styles = {
  ...
  heading: { fontSize: "26px", fontWeight: 600, color: "#1A1D29", margin: "0 0 6px" },
  subheading: { fontSize: "13px", color: "#6B7280", margin: "0 0 28px" },
  label: { display: "block", fontSize: "13px", fontWeight: 500, color: "#1A1D29", marginBottom: "6px" },
  input: { display: "block", width: "100%", padding: "11px 12px", marginBottom: "18px", fontSize: "15px", border: "1px solid #D8D8D3", borderRadius: "8px", background: "#fff", color: "#1A1D29", boxSizing: "border-box" },
  error: { fontSize: "13px", color: "#C0392B", margin: "-8px 0 16px" },
  button: { width: "100%", padding: "12px", fontSize: "15px", fontWeight: 600, color: "#1A1D29", background: "#E8A33D", border: "none", borderRadius: "8px", cursor: "pointer" },
};
